...
def tableau_cpg1():
    ...
    tableau = ttk.Treeview(frame3, columns=('Date','Horaire','Titre','Salle'),show = 'headings',selectmode='browse')
    vsb = ttk.Scrollbar(frame3,orient="vertical",command=tableau.yview)
    tableau.config(yscrollcommand=vsb.set)
    tableau.column('Date',width=150,anchor=CENTER)
    tableau.column('Horaire',width=150,anchor=CENTER)
    tableau.column('Titre',width=150,anchor=CENTER)
    ...
    tableau.place(x=200,y=200)
    vsb.place(x=170,y=200,height=200)
    ...
    for i in range(len(eventsCPG1)):
        if 'DS' in eventsCPG1[i][4] or 'ds' in eventsCPG1[i][4] or 'Ds' in eventsCPG1[i][4] or 'artiel' in eventsCPG1[i][4] or 'onseil de classe' in eventsCPG1[i][4]:
            ...
            tableau.insert('', 'end', iid=Count(), values=(text_date, text_heure, eventsCPG1[i][1], yu))
        ...
        if 'DS' in eventsCPG2[i][4] or 'ds' in eventsCPG2[i][4] or 'Ds' in eventsCPG2[i][4] or 'artiel' in eventsCPG2[i][4] or 'onseil de classe' in eventsCPG2[i][4]:
            for j in range(len(Liste_des_salles)):
                    if Liste_des_salles[j][0]==eventsCPG2[i][7]:
                        ...
                        text_heure=text_heure[11:16]
            tableau.insert('', 'end', iid=Count(), values=(text_date, text_heure, eventsCPG2[i][1], yu))
